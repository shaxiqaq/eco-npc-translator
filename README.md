...
面向《Emil Chronicle Online》(ECO) 的 **本地 Windows 工具箱**（当前版本 **v0.2.21**）。
...
`.github/workflows/release.yml` 会在 Windows Runner 上测试、构建，并创建 Release（标签必须与 `package.json` 版本一致，例如 `v0.2.21`）。Release 正文请粘贴 `CHANGELOG.md` 对应版本的中文说明。
