...
test('parseGameProcesses accepts a PowerShell JSON array', () => {
  const result = parseGameProcesses(
    '[{"pid":3200,"title":"ECO - 角色二","started":"10:02:03"},{"pid":1200,"title":"","started":"09:01:02"}]'
  );

  assert.deepEqual(result, [
    { pid: 1200, title: '', started: '09:01:02' },
    { pid: 3200, title: 'ECO - 角色二', started: '10:02:03' }
  ]);
});
